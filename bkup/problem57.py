...
# can be expressed as an infinite continued
# fraction.
#
...
# 577/408, but the eighth expansion, 1393/985, is
# the first example where the number of digits in
# the numerator exceeds the number of digits in the
# denominator.
# 
# In the first one-thousand expansions, how many
# fractions contain a numerator with more digits
# than denominator?
...
def continued(n):
    '''
    Returns the nth expansion of the
