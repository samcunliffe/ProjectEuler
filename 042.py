...
# ========================
# The n^(th) term of the sequence of triangle numbers
# is given by, t_(n) = 1/2n(n+1); so the first ten 
...
# nearly two-thousand common English words, how many
# are triangle words?
...
f=open("problem42data.txt","r") # opens the file
# the file is now in variable f
